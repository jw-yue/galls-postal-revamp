...
import { initializePaymentForms } from "./modules/payment-forms.js";
import {
...
window.GallsCheckout = {
  ...
  // Note: handleCCAForm will be added dynamically by initializePaymentForms()
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.GallsCheckout.handleCCAForm =
    window.GallsCheckout.initializePaymentForms.handleCCAForm;
});
